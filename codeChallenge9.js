...
now, they are just interested in knowing whether a dog is an adult or a puppy. A dog is an adult if it is at least 3 years old, and it's a puppy if it's less than 3 years
old.
Your tasks:
...
const kat = [4, 1, 15, 8, 3];

const checkDogs = function (dogsJulia, dogsKate) {
  const newArrJulia = dogsJulia.slice(1, 3);
  const allDogs = [...newArrJulia, ...dogsKate];

  allDogs.forEach(function (years, i) {
    console.log(
      years > 3
